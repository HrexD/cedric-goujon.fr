        ...
        try {
            $stmt = $pdo->prepare("
                UPDATE candidatures SET 
                    ...
                    entreprise = ?, lieu = ?, site_annonce = ?, url_annonce = ?, 
                    remuneration = ?, statut = ?, lettre_motivation = ?, 
                    notes = ?, date_candidature = ?
                WHERE id = ?
            ");
            ...
            $stmt->execute([
                ...
                $lettre_motivation, $notes, $date_candidature, $id
            ]);
...
// Si pas de POST, utiliser les données existantes
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    $nom = $candidature['nom'] ?? '';
    ...
    $site_annonce = $candidature['site_annonce'] ?? '';
    $url_annonce = $candidature['url_annonce'] ?? '';
    $remuneration = $candidature['remuneration'] ?? '';
...
<head>
    ...
    <title>✏️ Modifier une candidature</title>
...
<body>
    ...
    <div class="admin-layout">
        <header class="admin-header">
            <h1>✏️ Modifier une candidature</h1>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="date_candidature" id="date_candidature" value="<?= $date_candidature ?>">
                        </div>
                        <div class="form-group">
